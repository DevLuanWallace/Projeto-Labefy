        ...
        <div>
          ...
          {contentPlaylist.map((eachSong) => {
            return (
              ...
              position: "relative"}}
              >
                <iframe width="130" height="80" src={eachSong.url.replace("watch?v=","embed/").concat("?modestbranding=1")} title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"  />
